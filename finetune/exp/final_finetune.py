...
test_csv_path = "/home/akarmakar/codekitty/data/jemma_COMP_MAIN/JEMMA_COMP_valid_MAIN.csv"
...
df.to_csv(sys.path[0] + f"/{model_name}-finetuned-COMP" + "/eval_pred.csv", index=False, header=["pred_label"])
