...
for model in models:
    ...
    command = f"CUDA_VISIBLE_DEVICES=0,1,2,3 python3 /home/akarmakar/codekitty/finetune/finetune_and_evaluate.py --model_name {model} --tokenizer_name {model} --dataset_name {dataset} > {logfile}"
